...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_GET['sup_Ids'])) {
        ...
        $supplierId = json_decode($_GET['sup_Ids']);
        ...
        // Update query
        $sql = "UPDATE supplier SET s_name='$name', s_mail='$email', s_address='$address', s_phoneNo='$phone' WHERE supplier_id='$supplierId'";
    ...
    header("Location: 04.02.03.01.modsup.php");
    exit;
}
?>
<footer>
